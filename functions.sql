...
-- =========================================================================
-- ЗАПРОСЫ ДЛЯ ПРОВЕРКИ ФУНКЦИЙ (КОПИРУЙ И ВСТАВЛЯЙ ПО ОДНОМУ)
-- =========================================================================

-- ПРОВЕРКА 1: Скалярная функция (замени 1 на ID реальной игры из твоей БД)
...
-- ПРОВЕРКА 3: Сегментация клиента (замени 1 на ID реального пользователя)
